...
Prof. Mortensen is interested in CFD, scientific computing and the many aspects of turbulent fluid
...
such as plasma physics, biomedical flows, multiphase, numerical analysis and physics informed neural networks.
He has been working extensively with finite element (FEniCS) and spectral codes for Direct
Numerical Simulation (DNS) of turbulence, with codes preferably written in the high-level Python language. His latest venture is the open-source Jaxfun code that is using JAX for high-performance spectral Galerkin and Physics-Informed Neural Networks on CPUs, GPUs and TPUs.

If you are interested in learning more about the different research projects, please
